@props(['transaction'])
<a href="{{route('admin.transactions.show', $transaction->id)}}" {{$attributes->merge(['class'=>"flex items-center justify-between p-3 rounded-lg cursor-pointer hover:bg-gray-50"])}}>

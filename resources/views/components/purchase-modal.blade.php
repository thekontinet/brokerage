            ...
            <div class="relative inline-block px-4 pt-5 pb-4 overflow-hidden text-left align-bottom transition-all transform bg-white rounded-lg shadow-xl rtl:text-right dark:bg-gray-900 sm:my-8 sm:align-middle sm:max-w-sm sm:w-full sm:p-6">
                <div>
                    ...
                    <div class="mt-2 text-center">
                        <h3 class="text-lg font-medium leading-6 text-red-800 capitalize dark:text-white" id="modal-title">Please Do not use for production or organisation</h3>
                        <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">
                            This is a <strong>DEMO PHP INVESTMENT PROJECT</strong> 100% percent working with great features. If interested contact the developer by clicking on the blue button below.
                        </p>
                    </div>
                </div>

                <div class="mt-5">
                    <div class="flex flex-col items-center lg:justify-center lg:flex-row ">
                        ...
                        <a href="https://t.me/d_web_developer" class="w-full px-4 py-2 mt-2 text-sm font-medium tracking-wide text-center text-white capitalize transition-colors duration-300 transform bg-blue-600 rounded-md sm:w-auto sm:mt-0 hover:bg-blue-500 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-40">
                            Contact developer
                        </a>
                    </div>
                </div>
